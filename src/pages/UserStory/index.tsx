...
const UserStory = () => {
    ...
    const getPrivateStories = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:5175/stories/my/${id}`);
        ...
        <div>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
                {stories.map((story) => (
                    <div
                        key={story._id}
                        className="border border-gray-200 rounded-sm shadow-md p-4 w-[100%] sm:w-[16rem] text-center my-6"
                    >
                        ...
                        <div className='flex justify-center items-center my-4' onClick={() => {
